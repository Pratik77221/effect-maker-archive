...
2. Under **Assets**, download `effect-maker-archive-v0.4.1.zip` and extract it.
...
8. Open an Effect Maker project and click the extension icon. The controls should show **Version 0.4.1**.
